...
ORIGINAL_GOLIATH_PALETTE = [
    ...
    [255, 218, 0], # "Apparel"
    [102, 204, 0], # "Chair"
    [14, 0, 204], # "Eyeglass_Frame"
    [0, 204, 160], # "Eyeglass_Lenses"
    [128, 200, 255], # "Face_Neck"
    [255, 0, 109], # "Hair"
    [0, 255, 36], # "Headset"
    [189, 0, 204], # "Left_Foot"
    [255, 0, 218], # "Left_Hand"
    [255, 0, 218], # "Left_Lower_Arm"
    [0, 255, 145], # "Left_Lower_Leg"
    [189, 0, 204], # "Left_Shoe" 
    [182, 0, 255], #  "Left_Sock"
    [255, 0, 218], #  "Left_Upper_Arm" 
    [0, 255, 145], # "Left_Upper_Leg"
    [72, 0, 255], # "Lower_Clothing" 
    [204, 43, 0], # "Lower_Spandex" 
    [204, 131, 0], # "Right_Foot" 
    [255, 0, 0], # "Right_Hand" 
    [255, 0, 0], # "Right_Lower_Arm" 
    [189, 204, 0], # "Right_Lower_Leg" 
    [204, 131, 0], # "Right_Shoe" 
    [102, 0, 204], # "Right_Sock" 
    [255, 0, 0], # "Right_Upper_Arm" 
    [189, 204, 0], # "Right_Upper_Leg" 
    [14, 204, 0], # "Torso" 
    [0, 128, 72], # "Upper_Clothing" 
    [204, 0, 43], # "Visible_Badge" 
    [128, 200, 255], # "Lower_Lip" 
    [128, 200, 255], # "Upper_Lip" 
    [128, 200, 255], # "Lower_Teeth" 
    [128, 200, 255], # "Upper_Teeth"
    [128, 200, 255], # "Tongue"
]

COMMON_GOLIATH_CLASSES = [
    "Background", # "Background"
    "Apparel", # "Apparel"
    "Chair", # "Chair" !!!
    "Eyeglass_Frame", # "Eyeglass_Frame"  !!!
    "Eyeglass_Lenses", # "Eyeglass_Lenses" !!!
    "Face_Neck", # "Face_Neck"
    "Hair", # "Hair"
    "Headset", # "Headset" !!!
    "Left-leg", # "Left_Foot"
    "Left-arm", # "Left_Hand"
    "Left-arm", # "Left_Lower_Arm"
    "Left-leg", # "Left_Lower_Leg"
    "Left-shoe", # "Left_Shoe" 
    "Socks", #  "Left_Sock"
    "Left-arm", #  "Left_Upper_Arm" 
    "Left-leg", # "Left_Upper_Leg"
    "LowerClothing", # "Lower_Clothing" 
    "Lower_Spandex", # "Lower_Spandex" !!!
    "Right-leg", # "Right_Foot" 
    "Right-arm" , # "Right_Hand" 
    "Right-arm" , # "Right_Lower_Arm" 
    "Right-leg", # "Right_Lower_Leg" 
    "Right-shoe", # "Right_Shoe" 
    "Socks", # "Right_Sock" 
    "Right-arm" , # "Right_Upper_Arm" 
    "Right-leg", # "Right_Upper_Leg" 
    "Torso-skin", # "Torso" 
    "UpperClothes", # "Upper_Clothing" 
    "Visible_Badge", # "Visible_Badge" !!!
    "Face_Neck", # "Lower_Lip" 
    "Face_Neck", # "Upper_Lip" 
    "Face_Neck", # "Lower_Teeth" 
    "Face_Neck", # "Upper_Teeth"
    "Face_Neck", # "Tongue"
]
...
COMMON_GOLIATH_CLASSES = [x for x in COMMON_GOLIATH_CLASSES if x not in REMOVE_CLASSES]
...
COLOR_DICT = {
            ...
            'Left-leg':(255, 0, 255),
            'Torso-skin':(220, 220, 220),
            'Face':(139, 0, 0),
            'UpperClothes':(45, 135, 15),
            'Right-leg':(0, 0, 139),
            'Right-arm':(0, 100, 0),
            'Human':(20, 20, 20),
            'Coat':(255, 165, 0),
            'Left-shoe':(255, 192, 203),
            'Right-shoe':(128, 0, 128),
            'Hat':(128, 128, 128),
            'Dress':(144, 144, 0),
            'Socks':(255, 215, 0),
            'Scarf':(144, 238, 144),
