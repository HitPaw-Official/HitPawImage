...
def build_model_onnx(model_arch, **kwargs):
    if model_arch == "r34":
    ...
    elif model_arch == "vitae_tiny":
        model = p3mnet_vitae_s_tiny(**kwargs) 
    elif model_arch == "vitae_4channel":
        model = p3mnet_vitae_s_4channel(**kwargs)       
    else:
