...
@register_model
def ViTAE_noRC_MaxPooling_bias_basic_stages4_14_tiny(pretrained=False, **kwargs): # adopt performer for tokens to token
    model = ViTAE_noRC_MaxPooling_basic(RC_tokens_type=['performer', 'transformer', 'transformer', 'transformer'], NC_tokens_type=['performer', 'transformer', 'transformer', 'transformer'], stages=4, embed_dims=[32, 32, 64, 128], token_dims=[32, 64, 128, 256], downsample_ratios=[4, 2, 2, 2],
...
class ViTAE_noRC_MaxPooling_DecoderV1_tiny(nn.Module):
    def __init__(self):
        super().__init__()
        ##########################
        ### Decoder part - GLOBAL
        ...
        self.sbfi_2 = SBFI(64, 16, 8)
        self.sbfi_1 = SBFI(32, 16, 4)
        self.sbfi_0 = SBFI(32, 16, 2)

        self.dbfi_2 = DBFI(64, 256, 4)
        self.dbfi_1 = DBFI(32, 256, 8)
        self.dbfi_0 = DBFI(32, 256, 16)
