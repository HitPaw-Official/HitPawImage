...
@register_model
def ViTAE_noRC_MaxPooling_bias_basic_stages4_14_4channel(pretrained=True, **kwargs): # adopt performer for tokens to token
    model = ViTAE_noRC_MaxPooling_basic(in_chans=4, RC_tokens_type=['performer', 'transformer', 'transformer', 'transformer'], NC_tokens_type=['performer', 'transformer', 'transformer', 'transformer'], stages=4, embed_dims=[64, 64, 128, 256], token_dims=[64, 128, 256, 512], downsample_ratios=[4, 2, 2, 2],
...
class ViTAE_noRC_MaxPooling_DecoderV1_4channel(nn.Module):
    def __init__(self):
        super().__init__()
        ##########################
        ### Decoder part - GLOBAL
    ...
    def forward(self, x, feas):
        ...
        d4_l = F.interpolate(d4_l, scale_factor=2, mode="bilinear")
        ...
        d3_l = F.interpolate(d3_l, scale_factor=2, mode="bilinear")
        ...
        d2_l = F.interpolate(d2_l, scale_factor=2, mode="bilinear")
        ...
        d1_l = F.interpolate(d1_l, scale_factor=2, mode="bilinear")
        ...
        d0_l = F.interpolate(d0_l, scale_factor=2, mode="bilinear")
