...
from .unmaxpool_onnx import MaxUnpool2d
...
class ViTAE_noRC_MaxPooling_DecoderV1(nn.Module):
    def __init__(self):
        ...
        self.unmaxpool = MaxUnpool2d(kernel_size=2, stride=2)
...
class ViTAE_noRC_MaxPooling_Matting(nn.Module):
    ...
    def forward(self, x):
        embeddings, feas = self.encoder(x)
        return self.decoder(embeddings, feas)
